...
const hotels = [
    {
        ...
        note: (
            <>
                *Select <b>University of Technology Bahra*</b> as Rate Reference.
            </>
        ),
    },
    {
        ...
        note: (
            <>
                *Use <b>ROSIDT</b> as the Booking Code
            </>
        )
    },
    {
        ...
        note: (
            <>
                *Prior to booking, email <b><a href="mailto:Vanessa.vaquilar@accor.com">Vanessa.vaquilar@accor.com</a></b> or <b><a href="https://wa.me/97335358850">WhatsApp +973 35358850</a></b>
            </>
        ),
    },
    {
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    {hotels.map((hotel, idx) => (
                        <div key={idx} className="flex flex-col items-start bg-white p-4">
                            ...
                            {hotel.note && (
                                <div className="text-xs text-gray-700 mt-2">{hotel.note}</div>
                            )}
                        </div>
                    ))}
                </div>
